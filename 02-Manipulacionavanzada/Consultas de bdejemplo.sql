...
--crear una vista que visualize el total de los importes agrupados por productos 
-- en una vista los nombres de las columnas no se puden quedar sin nombres 
...
--seleccionar las nombres de los representantes y las oficinas donde trabajan 
-- 1 en un lugar trabajan muchos       



create or alter view vw_oficinas_representantes 
as
select r.Nombre, r.Ventas as [ventasrepresentantes],o.Oficina, o.Ciudad, o.Region, o.Ventas as [ventasoficina]
...
--- seleccionar los pedidos con fecha y importe el nombre del representante que lo realizo y al cliente que lo solocito 
...
--- seleccionar los pedidos con fecha y importe el nombre del representante que atendio al cliente que lo solocito 
